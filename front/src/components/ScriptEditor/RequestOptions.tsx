...
const RequestOptions: React.FC<RequestOptionsProps> = ({ options, onOptionsChange }) => {
  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        <div className="flex items-center space-x-2">
          <Switch
            ...
            onCheckedChange={(checked:boolean) => handleChange('verbose', checked)}
          />
        ...
        <div className="flex items-center space-x-2">
          <Switch
            ...
            onCheckedChange={(checked:boolean) => handleChange('insecure', checked)}
          />
        ...
        <div className="flex items-center space-x-2">
          <Switch
            ...
            onCheckedChange={(checked:boolean) => handleChange('followRedirects', checked)}
          />
        ...
        <div className="flex items-center space-x-2">
          <Switch
            ...
            onCheckedChange={(checked:boolean) => handleChange('compressed', checked)}
          />
        ...
        <div className="flex items-center space-x-2">
          <Switch
            id="fail"
            checked={options.fail}
            onCheckedChange={(checked:boolean) => handleChange('fail', checked)}
          />
        ...
        <div className="flex items-center space-x-2">
          <Switch
            id="ipv4Only"
            checked={options.ipv4Only}
            onCheckedChange={(checked:boolean) => handleChange('ipv4Only', checked)}
          />
        ...
        <div className="flex items-center space-x-2">
          <Switch
            id="ipv6Only"
            checked={options.ipv6Only}
            onCheckedChange={(checked:boolean) => handleChange('ipv6Only', checked)}
          />
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="flex items-center space-x-2">
          <Label htmlFor="maxRedirects" className="min-w-[120px]">Max Redirects</Label>
          <Input
            id="maxRedirects"
            type="number"
        ...
        <div className="flex items-center space-x-2">
          <Label htmlFor="timeout" className="min-w-[120px]">Timeout (s)</Label>
          <Input
            id="timeout"
            type="number"
        ...
        <div className="flex items-center space-x-2">
          <Label htmlFor="connectTimeout" className="min-w-[120px]">Connect Timeout (s)</Label>
          <Input
            id="connectTimeout"
            type="number"
        ...
        <div className="flex items-center space-x-2">
          <Label htmlFor="maxTime" className="min-w-[120px]">Max Time (s)</Label>
          <Input
            id="maxTime"
            type="number"
        ...
        <div className="flex items-center space-x-2">
          <Label htmlFor="retry" className="min-w-[120px]">Retry Count</Label>
          <Input
            id="retry"
            type="number"
            value={options.retry || ''}
        ...
        <div className="flex items-center space-x-2">
          <Label htmlFor="retryDelay" className="min-w-[120px]">Retry Delay (s)</Label>
          <Input
            id="retryDelay"
            type="number"
        ...
        <div className="flex items-center space-x-2">
          <Label htmlFor="rateLimit" className="min-w-[120px]">Rate Limit (B/s)</Label>
          <Input
            id="rateLimit"
            type="number"
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="flex items-center space-x-2">
          <Label htmlFor="proxy" className="min-w-[120px]">Proxy</Label>
          <Input
            id="proxy"
            type="text"
            value={options.proxy || ''}
        ...
        <div className="flex items-center space-x-2">
          <Label htmlFor="interface" className="min-w-[120px]">Interface</Label>
          <Input
            id="interface"
            type="text"
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="flex items-center space-x-2">
          <Label htmlFor="cert" className="min-w-[120px]">Certificate</Label>
          <Input
            id="cert"
            type="text"
            value={options.cert || ''}
        ...
        <div className="flex items-center space-x-2">
          <Label htmlFor="key" className="min-w-[120px]">Key</Label>
          <Input
            id="key"
            type="text"
            value={options.key || ''}
      ...
      <div className="flex items-center space-x-2">
        <Label htmlFor="keyPassword" className="min-w-[120px]">Key Password</Label>
        <Input
          id="keyPassword"
          type="password"
      ...
      <div className="flex items-center space-x-2">
        <Label htmlFor="outputFile" className="min-w-[120px]">Output File</Label>
        <Input
          id="outputFile"
          type="text"
      ...
      <div className="flex items-center space-x-2">
        <Label htmlFor="dnsServers" className="min-w-[120px]">DNS Servers</Label>
        <Input
          id="dnsServers"
          type="text"
          value={options.dnsServers ? options.dnsServers.join(', ') : ''}
          onChange={(e) => handleChange('dnsServers', e.target.value.split(',').map(s => s.trim()))}
          className="flex-1"
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="flex items-center space-x-2">
          <Switch
            id="timeNamelookup"
            checked={options.timeNamelookup}
            onCheckedChange={(checked:boolean) => handleChange('timeNamelookup', checked)}
          />
        ...
        <div className="flex items-center space-x-2">
          <Switch
            id="timeConnect"
            checked={options.timeConnect}
            onCheckedChange={(checked:boolean) => handleChange('timeConnect', checked)}
          />
        ...
        <div className="flex items-center space-x-2">
          <Switch
            id="timeAppconnect"
            checked={options.timeAppconnect}
            onCheckedChange={(checked:boolean) => handleChange('timeAppconnect', checked)}
          />
        ...
        <div className="flex items-center space-x-2">
          <Switch
            id="timePretransfer"
            checked={options.timePretransfer}
            onCheckedChange={(checked:boolean) => handleChange('timePretransfer', checked)}
          />
        ...
        <div className="flex items-center space-x-2">
          <Switch
            id="timeTotal"
            checked={options.timeTotal}
            onCheckedChange={(checked:boolean) => handleChange('timeTotal', checked)}
          />
