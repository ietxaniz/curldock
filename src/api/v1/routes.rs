...
use crate::api::common::models::{decode_query, PathQuery};
...
pub async fn handle_request(
    ...
    match (path, method) {
        ("/v1/data", &Method::GET) => handlers::load_data_file(decode_query::<PathQuery>(path)).await,
        ("/v1/data", &Method::DELETE) => handlers::delete_data_file(decode_query::<PathQuery>(path)).await,
        ...
        ("/v1/execute", &Method::POST) => handlers::execute_script(decode_query::<PathQuery>(path)).await,
        ...
        ("/v1/script", &Method::GET) => handlers::get_script_details(decode_query::<PathQuery>(path)).await,
